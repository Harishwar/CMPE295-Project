 ...
 */
public class RecommendationsHelper extends AsyncTask<String, String, String> {
    private OnTaskCompleted listener;
    private FitwhizApplication app;
    public RecommendationsHelper(FitwhizApplication fitwhizApplication)
    {
    ...
    protected String doInBackground(String... params) {
        ...
        String urlString = params[0]+"/v1.0/user/vaccinations?SensorId="+sensorId; // URL to call
        String result = "";
    ...
    protected  void onPostExecute(String response)
    {
        try {
            ...
            app.setVaccinations(json.getString("vaccination_desc"));
